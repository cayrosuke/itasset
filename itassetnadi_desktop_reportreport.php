...
class cNadi_Desktop_Report extends cTableBase {
	...
	function __construct() {
		...
		// serialcode
		$this->serialcode = new cField('Nadi_Desktop_Report', 'Nadi Desktop Report', 'x_serialcode', 'serialcode', '`serialcode`', '`serialcode`', 200, -1, FALSE, '`serialcode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['serialcode'] = &$this->serialcode;

		// latestupdate
		$this->latestupdate = new cField('Nadi_Desktop_Report', 'Nadi Desktop Report', 'x_latestupdate', 'latestupdate', '`latestupdate`', 'DATE_FORMAT(`latestupdate`, \'%d-%m-%Y\')', 133, 7, FALSE, '`latestupdate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
...
?>
	<tr>
		...
		<td class="ewGroupHeader"><?php echo $Nadi_Desktop_Report->serialcode->FldCaption() ?></td>
		<td class="ewGroupHeader"><?php echo $Nadi_Desktop_Report->latestupdate->FldCaption() ?></td>
	</tr>
<?php
	}
	while (!$Nadi_Desktop_Report_report->DetailRecordset->EOF) {
		...
		$Nadi_Desktop_Report->serialcode->setDbValue($Nadi_Desktop_Report_report->DetailRecordset->fields('serialcode'));
		$Nadi_Desktop_Report->latestupdate->setDbValue($Nadi_Desktop_Report_report->DetailRecordset->fields('latestupdate'));
...
<?php echo $Nadi_Desktop_Report->datereceived->ViewValue ?></span>
		...
		<td<?php echo $Nadi_Desktop_Report->serialcode->CellAttributes() ?>>
<span<?php echo $Nadi_Desktop_Report->serialcode->ViewAttributes() ?>>
<?php echo $Nadi_Desktop_Report->serialcode->ViewValue ?></span>
</td>
		<td<?php echo $Nadi_Desktop_Report->latestupdate->CellAttributes() ?>>
<span<?php echo $Nadi_Desktop_Report->latestupdate->ViewAttributes() ?>>
<?php echo $Nadi_Desktop_Report->latestupdate->ViewValue ?></span>
</td>
	</tr>
<?php
