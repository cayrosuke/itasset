...
if (!isset($Language)) {
	include_once "itassetewcfg12.php";
	include_once "itassetewshared12.php";
...
var EW_SESSION_URL = EW_RELATIVE_PATH + "itassetewsession12.php"; // Session URL
...
var EW_LOGOUT_URL = EW_RELATIVE_PATH + "itassetlogout.php"; // Logout URL
var EW_LOOKUP_FILE_NAME = "itassetewlookup12.php"; // Lookup file name
...
<script type="text/javascript" src="<?php echo $EW_RELATIVE_PATH ?>phpjs/itassetuserfn12.js"></script>
<script type="text/javascript">

// Write your client script here, no need to add script tags.
</script>
<?php } ?>
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("aerologicalogo1.ico") ?>"><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("aerologicalogo1.ico") ?>">
...
?>
<?php include_once "itassetewmobilemenu.php" ?>
		</div><!-- /.navbar-collapse -->
	</div><!-- /.container-fluid -->
</nav>
<?php } ?>
	...
	<div id="ewContentTable" class="ewContentTable">
		<div id="ewContentRow">
			<div id="ewMenuColumn" class="<?php echo $gsMenuColumnClass ?>">
				<!-- left column (begin) -->
				<div class="ewMenu">
<?php include_once "itassetewmenu.php" ?>
				</div>
				<!-- left column (end) -->
			</div>
