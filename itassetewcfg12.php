...
define("EW_PROJECT_NAME", "itinventory", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{6E5D033C-DA34-4C1B-AC0C-D8B1ECCFD39C}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'T7ie9esd83cl6N0x', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/itinventory.css", TRUE); // Project stylesheet file name
...
define("EW_ADMIN_PASSWORD", "p@ssw0rd", TRUE); // Administrator password
...
define("EW_UPLOAD_URL", "itassetewupload12.php", TRUE); // Upload URL
...
?>
<?php
define("EW_PDF_STYLESHEET_FILENAME", "phpcss/itassetewpdf.css", TRUE); // export PDF CSS styles
