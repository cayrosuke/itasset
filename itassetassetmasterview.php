...
$assetmaster_view = NULL; // Initialize page object first

class cassetmaster_view extends cassetmaster {
	...
	// Page object name
	var $PageObjName = 'assetmaster_view';
	...
	function Page_Init() {
		...
		if (@$_GET["no"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["no"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["no"] <> "") {
				...
				$sReturnUrl = "itassetassetmasterlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "itassetassetmasterlist.php"; // No matching record, return to list
					}
			}
			...
			$sReturnUrl = "itassetassetmasterlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($assetmaster_view)) $assetmaster_view = new cassetmaster_view();

// Page init
$assetmaster_view->Page_Init();

// Page main
$assetmaster_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$assetmaster_view->Page_Render();
?>
...
fassetmasterview.Lists["x_company"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fassetmasterview.Lists["x_company"].Options = <?php echo json_encode($assetmaster->company->Options()) ?>;
fassetmasterview.Lists["x_type"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fassetmasterview.Lists["x_type"].Options = <?php echo json_encode($assetmaster->type->Options()) ?>;
...
<?php } ?>
<?php $assetmaster_view->ExportOptions->Render("body") ?>
<?php
	foreach ($assetmaster_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if ($assetmaster->Export == "") { ?>
...
<?php } ?>
<?php $assetmaster_view->ShowPageHeader(); ?>
<?php
$assetmaster_view->ShowMessage();
?>
<form name="fassetmasterview" id="fassetmasterview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($assetmaster_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $assetmaster_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="assetmaster">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($assetmaster->assettag->Visible) { // assettag ?>
	<tr id="r_assettag">
		<td><span id="elh_assetmaster_assettag"><?php echo $assetmaster->assettag->FldCaption() ?></span></td>
...
<?php echo $assetmaster->assettag->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->servicetag->Visible) { // servicetag ?>
	<tr id="r_servicetag">
		<td><span id="elh_assetmaster_servicetag"><?php echo $assetmaster->servicetag->FldCaption() ?></span></td>
...
<?php echo $assetmaster->servicetag->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->ipaddress->Visible) { // ipaddress ?>
	<tr id="r_ipaddress">
		<td><span id="elh_assetmaster_ipaddress"><?php echo $assetmaster->ipaddress->FldCaption() ?></span></td>
...
<?php echo $assetmaster->ipaddress->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->employeeno->Visible) { // employeeno ?>
	<tr id="r_employeeno">
		<td><span id="elh_assetmaster_employeeno"><?php echo $assetmaster->employeeno->FldCaption() ?></span></td>
...
<?php echo $assetmaster->employeeno->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->employeename->Visible) { // employeename ?>
	<tr id="r_employeename">
		<td><span id="elh_assetmaster_employeename"><?php echo $assetmaster->employeename->FldCaption() ?></span></td>
...
<?php echo $assetmaster->employeename->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->company->Visible) { // company ?>
	<tr id="r_company">
		<td><span id="elh_assetmaster_company"><?php echo $assetmaster->company->FldCaption() ?></span></td>
...
<?php echo $assetmaster->company->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->department->Visible) { // department ?>
	<tr id="r_department">
		<td><span id="elh_assetmaster_department"><?php echo $assetmaster->department->FldCaption() ?></span></td>
...
<?php echo $assetmaster->department->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->type->Visible) { // type ?>
	<tr id="r_type">
		<td><span id="elh_assetmaster_type"><?php echo $assetmaster->type->FldCaption() ?></span></td>
...
<?php echo $assetmaster->type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->model->Visible) { // model ?>
	<tr id="r_model">
		<td><span id="elh_assetmaster_model"><?php echo $assetmaster->model->FldCaption() ?></span></td>
...
<?php echo $assetmaster->model->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->location->Visible) { // location ?>
	<tr id="r_location">
		<td><span id="elh_assetmaster_location"><?php echo $assetmaster->location->FldCaption() ?></span></td>
...
<?php echo $assetmaster->location->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->alternateIP->Visible) { // alternateIP ?>
	<tr id="r_alternateIP">
		<td><span id="elh_assetmaster_alternateIP"><?php echo $assetmaster->alternateIP->FldCaption() ?></span></td>
...
<?php echo $assetmaster->alternateIP->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->operatingsystem->Visible) { // operatingsystem ?>
	<tr id="r_operatingsystem">
		<td><span id="elh_assetmaster_operatingsystem"><?php echo $assetmaster->operatingsystem->FldCaption() ?></span></td>
...
<?php echo $assetmaster->operatingsystem->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->remarks->Visible) { // remarks ?>
	<tr id="r_remarks">
		<td><span id="elh_assetmaster_remarks"><?php echo $assetmaster->remarks->FldCaption() ?></span></td>
		<td data-name="remarks"<?php echo $assetmaster->remarks->CellAttributes() ?>>
<span id="el_assetmaster_remarks">
<span<?php echo $assetmaster->remarks->ViewAttributes() ?>>
<?php echo $assetmaster->remarks->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->officelicense->Visible) { // officelicense ?>
	<tr id="r_officelicense">
		<td><span id="elh_assetmaster_officelicense"><?php echo $assetmaster->officelicense->FldCaption() ?></span></td>
...
<?php echo $assetmaster->officelicense->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($assetmaster->datereceived->Visible) { // datereceived ?>
	<tr id="r_datereceived">
		<td><span id="elh_assetmaster_datereceived"><?php echo $assetmaster->datereceived->FldCaption() ?></span></td>
...
<?php echo $assetmaster->datereceived->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($assetmaster->Export == "") { ?>
<script type="text/javascript">
fassetmasterview.Init();
</script>
<?php } ?>
<?php
$assetmaster_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($assetmaster->Export == "") { ?>
...
<?php
$assetmaster_view->Page_Terminate();
?>
